    ...
    # cnio.api_key(apiKey)
        try:
            ...
            for mst in myresult:
                ...
                mycursorA.execute(spl,(datetime.strptime(json_res['createdAt'], '%Y-%m-%dT%H:%M:%S.%fZ'),mst[1]))
                ...
                if json_res['status'] == "finished":
                    ...
                    mycursorA.execute(spl,(datetime.strptime(json_res['updatedAt'], '%Y-%m-%dT%H:%M:%S.%fZ'),mst[1]))
